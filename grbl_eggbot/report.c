...
void report_gcode_modes()
{
  ...
  report_util_gcode_modes_M();
    ...
    if( gc_state.modal.spindle == SPINDLE_ENABLE_CW) { serial_write('3');} 
	else if( gc_state.modal.spindle == SPINDLE_ENABLE_CCW) { serial_write('4');} 
	else if( gc_state.modal.spindle == SPINDLE_DISABLE) { serial_write('5');} 
    break;
